 ...
 */
final class Version20220607022226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO fingering_per_instrument_pitch (id, instrument_id, midi_number_id, fingering_position_id) SELECT id, instrument_id, midi_number_id, fingering_position_id FROM __temp__fingering_per_instrument_pitch');
        ...
        $this->addSql('DROP INDEX IDX_279FBED9F905285E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pitch AS SELECT id, accidental_id, name, image_url FROM pitch');
        $this->addSql('DROP TABLE pitch');
        $this->addSql('CREATE TABLE pitch (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, accidental_id INTEGER DEFAULT NULL, name VARCHAR(25) NOT NULL, image_url BLOB DEFAULT NULL, CONSTRAINT FK_279FBED9F905285E FOREIGN KEY (accidental_id) REFERENCES accidental (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO pitch (id, accidental_id, name, image_url) SELECT id, accidental_id, name, image_url FROM __temp__pitch');
        $this->addSql('DROP TABLE __temp__pitch');
        $this->addSql('CREATE INDEX IDX_279FBED9F905285E ON pitch (accidental_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__fingering_per_instrument_pitch AS SELECT id, instrument_id, midi_number_id, fingering_position_id FROM fingering_per_instrument_pitch');
        $this->addSql('DROP TABLE fingering_per_instrument_pitch');
        $this->addSql('CREATE TABLE fingering_per_instrument_pitch (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, instrument_id INTEGER DEFAULT NULL, midi_number_id INTEGER DEFAULT NULL, fingering_position_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO fingering_per_instrument_pitch (id, instrument_id, midi_number_id, fingering_position_id) SELECT id, instrument_id, midi_number_id, fingering_position_id FROM __temp__fingering_per_instrument_pitch');
        $this->addSql('DROP TABLE __temp__fingering_per_instrument_pitch');
        $this->addSql('CREATE INDEX IDX_BB185579CF11D9C ON fingering_per_instrument_pitch (instrument_id)');
        $this->addSql('CREATE INDEX IDX_BB185579FD80BEB2 ON fingering_per_instrument_pitch (midi_number_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pitch AS SELECT id, accidental_id, name, image_url FROM pitch');
        $this->addSql('DROP TABLE pitch');
        $this->addSql('CREATE TABLE pitch (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, accidental_id INTEGER DEFAULT NULL, name VARCHAR(25) NOT NULL, image_url BLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO pitch (id, accidental_id, name, image_url) SELECT id, accidental_id, name, image_url FROM __temp__pitch');
        $this->addSql('DROP TABLE __temp__pitch');
        $this->addSql('CREATE INDEX IDX_279FBED9F905285E ON pitch (accidental_id)');
    }
