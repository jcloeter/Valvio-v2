 ...
 */
final class Version20220606124242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE octave (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, octave INTEGER NOT NULL)');
